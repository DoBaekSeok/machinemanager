...
<head>
	...
	<script type='text/javascript'>	
		function doSubmit() {
			...
			if(frm.leaseno.value.length == 0){
				alert("임대처코드를 입력 해 주세요");
				return;
			}
		...
		function setLeaseNo(leaseNo){
			var frm = document.getElementById("writeform");
			frm.leaseno.value = leaseNo;
		}
	...
	<div id="wrapper">
		...
		<div id="rightContent">			
			...
			<div id="write_setup">
				...
				<form id="writeform" action="setupwrite.action" method="post">
				...
				<c:choose>
					...
					<table class="view">					
						...
						<tr>
							<th> ㆍ 거래처코드</th>
							<td>
								<input type="text" name="leaseno" />
							</td>
						</tr>
						<tr>
							<th> ㆍ 설치비용</th>
							<td>
								<input type="text" name="setupcost" />
							</td>		                    							
						</tr>								
						<tr>
							<th> ㆍ 설치상태</th>
							<td>
								<select name="setupstatus">										
